            ...
            <div class="dashBoard">
                <div class="dashBoardCard" style="margin-top: 0px">
                  ...
                  <div class="dashBoardCard">
                    ...
                    <div>
                        <label for="">{{__('field.numberOfAuditedClinic')}} </label>
                    </div>
                    <div>
                        <h1 style="color: blue">{{$audited}}</h1>
                    </div>
                  </div>
                  <div class="dashBoardCard">
                    <div>
                  ...
                  <div class="dashBoardCard">
                    ...
                    <div>
                        <label for="">{{__('field.numberOfClinicalAuditor')}}</label>
                    </div>
                    <div>
                        <h1 style="color: blue">{{$clinicalAuditor}}</h1>
                    </div>
                  </div>
                  <div class="dashBoardCard">
                    <div>
